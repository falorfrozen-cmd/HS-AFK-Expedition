...
that the gate falls, and a suggested level. Low levels are safe with a small bonus;
high levels pay more Magic Find but fall sooner. You get a notification when the
siege is over. Claim as usual; your best wave per region and level is kept.
