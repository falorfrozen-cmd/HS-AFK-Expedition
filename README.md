...
0.8 (in progress): a **camp** you build up for your workers (nine buildings, camp resources, the Siege gate's Walls), **traits**, **adventurers** (world chests with the game's keys), **goblin hunters**, a **jeweler** working the game's own jewel recipes, and **team trips** with synergies; every item still comes from the game's own routines.
